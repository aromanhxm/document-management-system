...
<body onload="document.forms[0].elements[0].focus()">    
  ...
  <div id="login-container">
    ...
    <div class="block remove-margin" style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
      <form name="resetForm" method="post" action="PasswordReset" class="form-horizontal form-bordered form-control-borderless" id="form-reset">
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <div class="input-group">
              ...
              <input name="username" id="username" type="text" class="form-control input-lg" placeholder="Registered user name"/>
            </div>
          </div>
        </div>
